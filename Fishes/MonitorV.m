...
- (void) setMas{
    ...
    [_upV mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(_dealV.mas_left).offset(50);
        make.width.height.mas_equalTo(50);
    }];

    [_downV mas_makeConstraints:^(MASConstraintMaker *make) {
        make.bottom.equalTo(_dealV.mas_bottom).offset(0);
        make.left.equalTo(_dealV.mas_left).offset(50);
        make.width.height.mas_equalTo(50);
    }];

    [_leftV mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_dealV.mas_top).offset(50);
        make.left.equalTo(_dealV.mas_left).offset(0);
        make.width.height.mas_equalTo(50);
    }];

    [_rightV mas_makeConstraints:^(MASConstraintMaker *make) {
        make.top.equalTo(_dealV.mas_top).offset(50);
        make.right.equalTo(_dealV.mas_right).offset(0);
        make.width.height.mas_equalTo(50);
    }];
}
//点击按钮触发事件
